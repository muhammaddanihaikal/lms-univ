...
public class AdmissionTest extends env_target {
    ...
    void admissionApproveCandidate(){
        ...
        driver.findElement(By.id("field-:r5:")).sendKeys("Ahmad Sahroni"+ Utils.randomNumber(2));
        // simpan fullName
        String fullName = driver.findElement(By.id("field-:r5:")).getAttribute("value");
        // nisn
        driver.findElement(By.id("field-:r7:")).sendKeys( Utils.randomNumber(8));
        // gender
        new Select(driver.findElement(By.id("field-:r9:"))).selectByVisibleText("Male");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='" + fullName + "']")));
    }
...
//        // klik button titik 3
//        By actionButton = By.xpath(
//                "//tr[td[normalize-space()='" + "REG2025229650" + "']]//button[@aria-label='Actions']"
//        );
//        wait.until(ExpectedConditions.elementToBeClickable(actionButton)).click();
//
//        // tunggu sampe pop up muncul
...
//
//        // validasi kalo datanya sudah hilang
//        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//tr[td[normalize-space()='" + "REG2025229650" + "']]")));
        ...
        // validasi kalo data yang di approve sudah ada di master student
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='" + "Ahmad Sahroni41" + "']")));
